...
@section('content')
  ...
  <section class="sec7">
    ...
    <div class="right">
      ...
      <img src="{{ url('asset/image/Noneimage.png') }}" alt="comming soon">
    @else
      <img onclick="arrowChangeimg()" src="{{ url('asset/image/' . $kaydomain . '/Thebrochure/' . $Thebrochureimages[0]) }}"
      alt="comming soon">
      {{-- <div class="navigation">
    ...
    <div class="left">
      ...
      <a href="{{ route('writingandparticipating', ['subdomain' => request()->route('subdomain')]) }}" target="_blank"
      rel="noopener noreferrer">اضغط هنا</a>
    </div>
    </div>
  ...
  <section class="sec8">
    ...
    @if ($lang_dom == 'ar')
<p>إقرار نظام مراجعة الأبحاث</p>
    @elseif ($lang_dom == 'en')
<p>Approval of the research review system</p>
    @endif
    <div class="paragraph">
      @if ($lang_dom == 'ar')
      <p dir="rtl">تم استخدام خدمة Microsoft CMT لإدارة عملية مراجعة الأقران لهذا المؤتمر. وقد قدمت مايكروسوفت هذه
      الخدمة مجانًا، وتحمّلت جميع النفقات، بما في ذلك تكاليف خدمات Azure السحابية، بالإضافة إلى تكاليف تطوير ودعم
      البرامج.</p>

    @elseif ($lang_dom == 'en')
      <p dir="ltr">The Microsoft CMT service was used for managing the peer-reviewing process for this conference.
      This service was provided for free by Microsoft and they bore all expenses, including costs for Azure cloud
    ...
    <div class="addCMT3">
      @if ($lang_dom == 'ar')
      <p>هذا إنجاز علمي مهم يعزز من أهمية المؤتمر الهندسي الخامس كمنصة أكاديمية للنشر والبحث والتطوير!

      نشر الأوراق البحثية المقبولة في المستودع الرقمي والمجلات العلمية المعتمدة من DOLJ ( المجلة الدولية للعلوم
      والتقنية ISTJ) ومجلة الطاقة الشمسية والتنمية المستدامة (مفهرسة سكوبس) يضمن وصول الأبحاث إلى نطاق أوسع، ويتيح
      للباحثين فرصة للتأثير العلمي والمشاركة الدولية.

      خطوة رائعة لدعم مجتمع البحث العلمي وتعزيز الابتكار في مجالات الهندسة والتقنية ، مما يساهم في التطوير والاستدامة.
      </p>
    @elseif ($lang_dom == 'en')
      <p>This is a significant scientific achievement that enhances the importance of the Fifth Engineering Conference
      as an academic platform for publishing, research, and development!

      Publishing accepted research papers in the digital repository and accredited scientific journals by DOLJ
      (International Science and Technology Journal ISTJ) and the Solar Energy and Sustainable Development Journal
      (Scopus-indexed) ensures broader reach for the research and provides researchers with an opportunity for
      scientific impact and international collaboration.

      A remarkable step to support the scientific research community and promote innovation in engineering and
      technology, contributing to development and sustainability.</p>
    @endif
    </div>
